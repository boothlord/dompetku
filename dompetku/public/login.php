...
?>
<!doctype html>
<html><head><meta charset="utf-8"><title>Login - DompetKu</title>
<style>
    :root {
...
<header><h2>DompetKu — Masuk</h2><a href="register.php">Daftar</a></header>
<div class="card login-card"> <?php if(isset($_GET['registered'])):?><div class="small" style="color:green">Registrasi sukses. Silakan masuk.</div><?php endif; ?>
...
<div class="form-row"><button type="submit">Masuk</button></div>
</form>
</div>
</body></html>